...
import { photographyPackages } from '../data/weddingData';
...
const Photography = () => {
  ...
  const [selectedPackage, setSelectedPackage] = useState<typeof photographyPackages[0] | null>(null);
  ...
  const filteredPackages = photographyPackages.filter(pkg => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section 
          ...
          style={{ 
            backgroundImage: "url('https://d2ajlz7o3p8ddv.cloudfront.net/media/event/card_image/Vishal_2.jpg')",
          }}
        >
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-white text-xl max-w-3xl mx-auto">
              Capture your special moments with our experienced photographers
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            {filteredPackages.length === 0 ? (
              <div className="text-center py-10">
                <h3 className="text-xl font-medium">No photography packages found for "{searchTerm}"</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-gray-500">Package Type</h4>
